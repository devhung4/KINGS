<template>
  <view>
    <view class="homeme_had">
      <view class="lef" @click="pasPoup = true">
        <image :src="userInfo.avatar || '../../static/black/authon.png'" />
      </view>
      <div class="rig">
        <!-- <image src="../../static/black/bx.png" /> -->
        <image @click="gomessage()" src="../../static/black/kf.png" />
        <!-- <image src="../../static/black/xx.png" /> -->
      </div>
    </view>

    <u-popup :show="pasPoup" mode="left" @close="pasPoup = false" class="pas_pop">
      <div class="hed" @click="gorenzhe()">
        <image class="authon" :src="userInfo.avatar || '../../static/black/authon.png'" />
        <div>
          {{
      ...
      <view class="poup_hed">
        ...
        <div class="lab4">
          ...
          <image @click="copyContent(userInfo.memberId)" src="../../static/black/copy.png" />
        </div>
      </view>
      <div class="list">
        <div class="itm" v-for="(item, index) in list" :key="index" @click="godetail(item.path)">
          <div class="itm_lef">
            <image :src="item.logo" />
            <div>{{ item.name }}</div>
          </div>
          ...
          <image v-else class="itm_rig" src="../../static/black/go.png" />
        </div>
      </div>
